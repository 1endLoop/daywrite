...
const CommunityContainer = () => {
  ...
  return (
        <div>
          <S.TabMenu>
            <Link to="/community">
              <S.TabItem $isActive={location.pathname === "/community"}>
                홈
              </S.TabItem>
            </Link>
            <Link to="/community/list">
              <S.TabItem $isActive={location.pathname === "/community/list"}>
                전체 글
              </S.TabItem>
            </Link>
            <Link to="/community/my">
              <S.TabItem $isActive={location.pathname === "/community/my"}>
                내가 쓴 글
              </S.TabItem>
            </Link>
            <Link to="/community/collection">
              <S.TabItem $isActive={location.pathname === "/community/collection"}>
                컬렉션
              </S.TabItem>
            </Link>
          </S.TabMenu>
